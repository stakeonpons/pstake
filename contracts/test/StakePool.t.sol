...
contract StakePoolTest is Test {
    ...
    function test_stakeAndEarnTheSameToken() public {
        ...
        assertEq(totalStaked, 1_000_000e18, "claiming must not consume principal");
    }
    ...
    function test_twoStakers_splitDeposit_principalIntact() public {
        ...
        assertEq(aliceAmount, 1_000_000e18, "alice principal returned in full");
        assertEq(bobAmount, 1_000_000e18, "bob principal returned in full");
