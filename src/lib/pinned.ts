/**
 * The Stake token's own listing.
 *
 * Stake's token is the first launched on the platform, so on /tokens it is **always first and
 ...
 * Stake staking model, no error anywhere. Since the whole feature switches on this one string,
